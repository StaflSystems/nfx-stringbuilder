#==============================================================================
# nfx-stringbuilder - Library installation
#==============================================================================
...
message(STATUS "  CMake configs: ${CMAKE_INSTALL_PREFIX}/${CMAKE_INSTALL_LIBDIR}/cmake/nfx-stringbuilder")
...
install(
	DIRECTORY "${NFX_STRINGBUILDER_INCLUDE_DIR}/"
...
install(
	EXPORT nfx-stringbuilder-targets
	FILE nfx-stringbuilder-targets.cmake
	NAMESPACE nfx-stringbuilder::
	DESTINATION ${CMAKE_INSTALL_LIBDIR}/cmake/nfx-stringbuilder
	COMPONENT Development
)
...
if(CMAKE_CONFIGURATION_TYPES)
	foreach(CONFIG ${CMAKE_CONFIGURATION_TYPES})
		install(
			EXPORT nfx-stringbuilder-targets
			FILE nfx-stringbuilder-targets-${CONFIG}.cmake
			NAMESPACE nfx-stringbuilder::
			DESTINATION ${CMAKE_INSTALL_LIBDIR}/cmake/nfx-stringbuilder
...
write_basic_package_version_file(
	"${CMAKE_CURRENT_BINARY_DIR}/nfx-stringbuilder-config-version.cmake"
	VERSION ${PROJECT_VERSION}
	COMPATIBILITY SameMajorVersion
)

configure_package_config_file(
	"${CMAKE_CURRENT_SOURCE_DIR}/cmake/nfx-stringbuilder-config.cmake.in"
	"${CMAKE_CURRENT_BINARY_DIR}/nfx-stringbuilder-config.cmake"
	INSTALL_DESTINATION ${CMAKE_INSTALL_LIBDIR}/cmake/nfx-stringbuilder
)
...
if(NFX_STRINGBUILDER_BUILD_DOCUMENTATION)
	install(
