#==============================================================================
# nfx-stringbuilder - Library packaging configuration (CPack)
#==============================================================================
...
if(NOT NFX_STRINGBUILDER_PACKAGE_SOURCE
		AND NOT NFX_STRINGBUILDER_PACKAGE_ARCHIVE
		AND NOT NFX_STRINGBUILDER_PACKAGE_DEB
		AND NOT NFX_STRINGBUILDER_PACKAGE_RPM
		AND NOT NFX_STRINGBUILDER_PACKAGE_WIX)
	return()
endif()
...
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY   "Cross-platform C++20 library for zero-allocation string building with Small Buffer Optimization ")
...
set(CPACK_RESOURCE_FILE_LICENSE         ${NFX_STRINGBUILDER_LICENSE_FILE})
...
if(NFX_STRINGBUILDER_PACKAGE_SOURCE)
...
set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY  "nfx-stringbuilder")
...
if(NOT DEFINED CPACK_GENERATOR)
	...
	# --- Archive packages ---
	if(NFX_STRINGBUILDER_PACKAGE_ARCHIVE)
		if(UNIX AND NOT APPLE)
...
if("RPM" IN_LIST CPACK_GENERATOR AND UNIX AND NOT APPLE)
	...
	set(CPACK_RPM_PACKAGE_LICENSE      ${NFX_STRINGBUILDER_LICENSE})
